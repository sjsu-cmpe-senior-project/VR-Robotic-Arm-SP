...
public class LeapMotion extends Service implements LeapDataListener, LeapDataPublisher, PointPublisher {
  ...
  public com.leapmotion.leap.Vector getPalmNormal() {
    com.leapmotion.leap.Hand h = controller.frame().hands().rightmost();
    return h.palmNormal();
  }
  ...
  public com.leapmotion.leap.Vector getPalmPosition() {
    com.leapmotion.leap.Hand h = controller.frame().hands().rightmost();
